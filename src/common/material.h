#ifndef STINGRAY_MATERIAL_H
#define STINGRAY_MATERIAL_H

#include "stingray_util.h"

// Used for reference .... need to understand better
struct hit_record;
...
class lambertian : public material {
    public:
        ...
        virtual bool scatter(const ray& r_in, const hit_record& record, color& attenuation, ray& scattered
        ) const override{
...
class dielectric : public material {
    public:
        ...
        virtual bool scatter(
            ...
            double refraction_ratio = rec.is_front_facing ? (1.0 / ir) : ir;
